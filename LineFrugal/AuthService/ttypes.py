            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _ in range(elem0):
                        elem1 = VerificationType(iprot.readI32())
...
class AuthSessionRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.metaData is not None:
            ...
            for elem7, elem6 in self.metaData.items():
...
class IdentifierConfirmationRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.metaData is not None:
            oprot.writeFieldBegin('metaData', TType.MAP, 1)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metaData))
            for elem12, elem11 in self.metaData.items():
...
class IdentityCredentialRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.metaData is not None:
            oprot.writeFieldBegin('metaData', TType.MAP, 1)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metaData))
            for elem17, elem16 in self.metaData.items():
...
class IdentityCredentialResponse(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    self.metaData = {}
                    (_, _, elem18) = iprot.readMapBegin()
                    for _ in range(elem18):
                        elem20 = iprot.readString()
                        elem19 = iprot.readString()
                        self.metaData[elem20] = elem19
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.metaData is not None:
            oprot.writeFieldBegin('metaData', TType.MAP, 1)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metaData))
            for elem22, elem21 in self.metaData.items():
...
class AuthLoginRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.metaData is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metaData))
            for elem27, elem26 in self.metaData.items():
...
class AuthLoginResponse(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    self.metaData = {}
                    (_, _, elem28) = iprot.readMapBegin()
                    for _ in range(elem28):
                        elem30 = iprot.readString()
                        elem29 = iprot.readString()
                        self.metaData[elem30] = elem29
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.metaData is not None:
            oprot.writeFieldBegin('metaData', TType.MAP, 1)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metaData))
            for elem32, elem31 in self.metaData.items():
...
class TalkException(TException):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    self.parameterMap = {}
                    (_, _, elem33) = iprot.readMapBegin()
                    for _ in range(elem33):
                        elem35 = iprot.readString()
                        elem34 = iprot.readString()
                        self.parameterMap[elem35] = elem34
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parameterMap is not None:
            ...
            for elem37, elem36 in self.parameterMap.items():
